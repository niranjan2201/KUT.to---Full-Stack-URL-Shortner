...
const ResetPassword = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.error(error);
            const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Failed to reset password. Token may have expired.';
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col justify-center px-16 text-white z-10">
                    ...
                    >
                        Secure your account.<br />Stay in control.
                    </motion.h1>
                    ...
                    >
                        Create a strong password to protect your links and analytics.
                    </motion.p>
                </div>
            </motion.div>
            ...
            <div className="w-full lg:w-1/2 flex justify-center items-center px-6">
                ...
                >
                    ...
                    <div className="backdrop-blur-xl bg-white/80 border border-white/20 rounded-2xl shadow-2xl p-8">
                        <h2 className="text-2xl text-gray-900 mb-1">Set New Password</h2>
                            ...
                            <div>
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pr-12 rounded-lg bg-white/70 backdrop-blur-md border ${errors.password ? 'border-red-400' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                    />
                                    <button
                                        type="button"
                            ...
                            <div>
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 pr-12 rounded-lg bg-white/70 backdrop-blur-md border ${errors.confirmPassword ? 'border-red-400' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                    />
                                    <button
                                        type="button"
